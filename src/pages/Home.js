      ...
      <main className="homepage">
        ...
        <div className="paragraphe">
          ...
          <h5>
            ...
            Le réseau offre des rendez-vous mensuels pour réseauter et se tenir à jour sur les actualités professionnelles locales.  Notre groupe Facebook nous permet de consulter en tout temps ces 1800 professionnel.le.s et aller chercher les réponses, ressources et conseils qui font la différence. 
          </h5>
        </div>
        <div className="paragraphe">
