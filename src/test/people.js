const freelances = [
  {
    ...
    firstname: 'John',
    lastname: 'Doe',
    urlPhoto: require('./photos/01.jpg'),
  ...
  },
  {
    ...
    firstname: 'Martin',
    lastname: 'Saville',
    urlPhoto: require('./photos/02.jpg'),
  ...
  },
  {
    ...
    firstname: 'Caya',
    lastname: 'Ganelon',
    urlPhoto: require('./photos/03.jpg'),
  ...
  },
  {
    ...
    firstname: 'Roland',
    lastname: 'Lanteigne',
    urlPhoto: require('./photos/04.jpg'),
  ...
  },
  {
    ...
    firstname: 'Angelette',
    lastname: 'Baron',
    urlPhoto: require('./photos/05.jpg'),
